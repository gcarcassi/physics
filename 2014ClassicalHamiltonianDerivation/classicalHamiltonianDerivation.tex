...
Let $I_1$ and $I_2$ be two orthogonal sets of labels and $I = I_1 \times I_2$. Let $f:I \leftrightarrow I$ be a bijective map. The labels are said independent iff we can define two sets of orthogonal labels $I_1'$ and $I_2'$ such that we can define separate maps:
\begin{enumerate}
\item $I_1' \times I_2' = I$
