...
\begin{document}
	\begin{tikzpicture}[scale=.4]
		...
		% styles		
	    \tikzstyle{axis}=[thick,color=black];				
	    \tikzstyle{line}=[color=black,dashed];  % dashed better than dotted?
	    \tikzstyle{function}=[ultra thick,color=red];			    
		...
		\draw [style=function] plot [smooth] coordinates {(-8,-3) (0,0) (\linea,\lineheighta) (\lineb,\lineheightb) (8,6)};
		...
		\filldraw [draw=red,fill=white,thick] (\displace + \linec,\functionheight) circle (.25);
