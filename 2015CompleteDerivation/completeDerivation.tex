...
In other words, not only our simple model is consistent, but it has predictive power: it provides intuition that is well supported by these findings. It is not ``just a mathematical trick".
