...
We now turn our attention to the metric $d\mu$ which we need to properly identify. It turns out that before we can do it, we need to better characterize $\mathcal{S}$.
